...
public class UnsignedItemCommand extends Command {
    {
        setDescription("");
    }
    ...
    public void execute(MapleClient c, String[] params) {
        ...
        if (params.length < 1) {
            player.yellowMessage("Syntax: !unsigneditem <itemid> <quantity>");
            return;
        }
        ...
        if (ItemConstants.isPet(itemId)) {
                if (params.length >= 2){   // thanks to istreety & TacoBell
                        ...
                        player.yellowMessage("Pet Syntax: !unsigneditem <itemid> <expiration>");
                        return;        
                }
        }
